<template>
    ...
    <ProfileItem title="Чат">
        ...
        <template v-slot:note>
            <p>Никнейм обязателен, чтобы войти в чат. Вы будете видеть только тех пользователей, которые находятся с вами в одной комнате.</p>
            <p>Чат сделан с использованием технологии Websockets. Пока данные затираются при преходе на другие вкладки, но в дальнейшем я собираюсь исправить этот функционал и сохранять переписку в комнатах на локальном сервере используя Node.js</p>
        </template>
    </ProfileItem>
</template>
