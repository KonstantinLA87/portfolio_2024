    ...
    <main>
        ...
        <div v-else class="flex flex-column gap-3">
            <Message severity="warn mb-6">
                ВАЖНО: Если вы видите это сообщение, значит данный раздел пока что еще находится на стадии разработки. Сейчас из реализован функционал только подтягивания данных с сервера Firebase. В ближашие дни я хочу оформить эти данные и сделать возможность добавлять/удалять/редактировать данные.
            </Message>
            <div
